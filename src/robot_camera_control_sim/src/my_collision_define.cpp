...
int main(int argc, char** argv)
{
    ...
    // -------------------- 光学平台（使用 STL 网格）--------------------
    // 1. 加载 STL 文件
    std::string stl_path = "package://optical_platiform_description/meshes/optical_platiform_base_link.STL";
    // 或者使用绝对路径，例如："/home/lk/ur_sim/src/optical_platform_description/meshes/optical_platiform_base_link.STL"
    // 为了可靠，这里先用绝对路径示范，您可以根据需要改为 package:// 方式（需要解析）
    std::string absolute_path = "/home/lk/ur_sim/src/optical_platiform_description/meshes/optical_platiform_base_link.STL";
